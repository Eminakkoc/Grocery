...
export default function ProductItem({ product }: Props) {
    return (
        <Link
            ...
            className="cursor-pointer flex flex-col justify-center items-center gap-(--spacing-s) card w-[300px] h-[300px] max-md:w-[200px] max-md:h-[230px] max-sm:w-[300px] max-sm:h-[300px] p-(--spacing-m)"
        >
            <Image
                unoptimized
